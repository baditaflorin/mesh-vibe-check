...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-vibe-check-50d2c0)](https://baditaflorin.github.io/mesh-vibe-check/)
...
**Source → https://github.com/baditaflorin/mesh-vibe-check**
...
git clone https://github.com/baditaflorin/mesh-vibe-check
cd mesh-vibe-check
npm install
npm run dev
```
...
- `mesh-vibe-check:signalingUrl`
- `mesh-vibe-check:turnTokenUrl`
- `mesh-vibe-check:iceServers`
- `mesh-vibe-check:room`
